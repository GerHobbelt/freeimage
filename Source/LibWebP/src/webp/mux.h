...
//   enc_options - (in) encoding options; can be passed nullptr to pick
//                      reasonable defaults.
// Returns:
...
// The last call to 'WebPAnimEncoderAdd' should be with frame = nullptr, which
...
// frame = nullptr; if not, the duration of the last frame will be internally
// estimated.
// Parameters:
...
// Returns:
//   nullptr if 'enc' is nullptr. Otherwise, returns the error string if the last call
