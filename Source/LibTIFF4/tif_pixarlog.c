...
PixarLogSetupDecode(TIFF* tif)
{
	...
	sp->tbuf = (uint16_t *) _TIFFmalloc(tbuf_size+sizeof(uint16_t)*sp->stride);
	if (sp->tbuf == nullptr)
		return (0);
...
static const TIFFField pixarlogFields[] = {
    {TIFFTAG_PIXARLOGDATAFMT, 0, 0, TIFF_ANY, 0, TIFF_SETGET_INT, TIFF_SETGET_UNDEFINED, FIELD_PSEUDO, FALSE, FALSE, "", nullptr},
    {TIFFTAG_PIXARLOGQUALITY, 0, 0, TIFF_ANY, 0, TIFF_SETGET_INT, TIFF_SETGET_UNDEFINED, FIELD_PSEUDO, FALSE, FALSE, "", nullptr}
};
