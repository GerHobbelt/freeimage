...
MapTransparentTableToAlpha1(RGBQUAD *target, uint8_t *source, uint8_t *table, int transparent_pixels, int width_in_pixels) {
	for (int cols = 0 ; cols < width_in_pixels ; cols++) {
		int index = (source[cols>>3] & (0x80 >> (cols & 0x07))) != 0 ? 1 : 0;
...
static void DLL_CALLCONV
MapTransparentTableToAlpha4(RGBQUAD *target, uint8_t *source, uint8_t *table, int transparent_pixels, int width_in_pixels) {
    BOOL low_nibble = FALSE;
    int x = 0;
...
static void DLL_CALLCONV
MapTransparentTableToAlpha8(RGBQUAD *target, uint8_t *source, uint8_t *table, int transparent_pixels, int width_in_pixels) {
    for (int cols = 0; cols < width_in_pixels; cols++) {
