...
function FreeImage_OpenMemory(data: PByte = nil; size_in_bytes: uint32_t = 0): PFIMEMORY; stdcall;
...
function FreeImage_AcquireMemory(stream: PFIMEMORY; var data: PByte;
  var size_in_bytes: uint32_t): LongBool; stdcall;
...
function FreeImage_ZLibCompress(target: PByte; target_size: uint32_t; source: PByte; source_size: uint32_t): uint32_t; stdcall;
  external FIDLL {$IFDEF WIN32}name '_FreeImage_ZLibCompress@16'{$ENDIF};
function FreeImage_ZLibUncompress(target: PByte; target_size: uint32_t; source: PByte; source_size: uint32_t): uint32_t; stdcall;
  external FIDLL {$IFDEF WIN32}name '_FreeImage_ZLibUncompress@16'{$ENDIF};
function FreeImage_ZLibGZip(target: PByte; target_size: uint32_t; source: PByte; source_size: uint32_t): uint32_t; stdcall;
  external FIDLL {$IFDEF WIN32}name '_FreeImage_ZLibGZip@16'{$ENDIF};
function FreeImage_ZLibGUnzip(target: PByte; target_size: uint32_t; source: PByte; source_size: uint32_t): uint32_t; stdcall;
  external FIDLL {$IFDEF WIN32}name '_FreeImage_ZLibGUnzip@16'{$ENDIF};
function FreeImage_ZLibCRC32(crc: uint32_t; source: PByte; source_size: uint32_t): uint32_t; stdcall;
...
function FreeImage_GetTagCount(tag: PFITAG): uint32_t; stdcall;
  external FIDLL {$IFDEF WIN32}name '_FreeImage_GetTagCount@4'{$ENDIF};
function FreeImage_GetTagLength(tag: PFITAG): uint32_t; stdcall;
...
function FreeImage_SetTagCount(tag: PFITAG; count: uint32_t): LongBool; stdcall;
  external FIDLL {$IFDEF WIN32}name '_FreeImage_SetTagCount@8'{$ENDIF};
function FreeImage_SetTagLength(tag: PFITAG; length: uint32_t): LongBool; stdcall;
